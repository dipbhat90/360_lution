...
<body>
    <x-header/>
     ...
     <div class="mobile-menu">
        ...
        <!-- pricing-page -->
        <div class="testimonial__page p_relative see__pad">
            <div class="testimonial___data">
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-12">
                        <div class=" testimonials__block__one page">
        ...
        <!-- accomplised-section -->
        <section class="accomplised__section__two see__pad">
            <div class="auto-container">
                <div class="accomplised__data two p_relative">
                    <div class="row">
